 ...
 * @return boolean
 */
function matchDepStructure(dep) {
  return dep && typeof dep === 'object' && dep.hasOwnProperty('version') && dep.hasOwnProperty('resolved')
}
/**
...
function yarnParseAndVerify(lockfileBuffer) {
  ...
  if (!lockfile || typeof lockfile !== 'object') {
    throw Error('No content found in lockfile')
  }
  const [sampleKey, sampleValue] = Object.entries(lockfile)[0]
  if (!sampleKey.match(/.*@.*/) || !matchDepStructure(sampleValue)) {
